                ...
                <div class="content">
                    <div class="thumbnail" v-for="food in foods">
                        ...
                        <div class="caption">
                            ...
                            <p><button class="btn btn-success btn-block add" v-on:click="add(food.name, food.codes)">追加</buttona></p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="content">
                    <div class="thumbnail" v-for="drink in drinks">
                        ...
                        <div class="caption">
                            ...
                            <p><button class="btn btn-success btn-block add" v-on:click="add(drink.name, drink.codes)">追加</button></p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="content">
                    <div class="thumbnail" v-for="dessert in desserts">
                        ...
                        <div class="caption">
                            ...
                            <p><button class="btn btn-success btn-block add" v-on:click="add(dessert.name, dessert.codes)">追加</button></p>
                        </div>
                    </div>
                </div>
            </div>
